...
RUN apt update;DEBIAN_FRONTEND=noninteractive apt install cmake g++ make git libboost-all-dev libavcodec-dev libavformat-dev libavresample-dev libswscale-dev libeigen3-dev libusb-1.0-0-dev  libpython3-dev python3-pip -y; apt clean --dry-run; apt autoclean;  mkdir /home/libs
